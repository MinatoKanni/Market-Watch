...
//		Thread.sleep(2000);
//		WebElement basket = driver.findElement(By.xpath("//iframe[@id='basket']"));
//		driver.switchTo().frame(basket);
//
//		Thread.sleep(1000);
//
//		//Actions d=new Actions(driver);
//	//	WebElement addBasket = driver.findElement(By.xpath("(//span[@class='edit_btn'])[2]"));
////		Thread.sleep(3000);
////		d.moveToElement(addBasket).perform();
////		JavascriptExecutor js = (JavascriptExecutor) driver;
////	       js.executeScript("arguments[0].click();", addBasket);
//
////		driver.findElement(By.xpath("//span[text()='BASKET']"));
////		Thread.sleep(1000);
//
...
public void user_navigate_to_navia_live() throws InterruptedException, AWTException {
	...
	sendValues(l.getClientCode(), "82486527");
